            ...
            <div class="flex flex-col">
                ...
                <div class="rounded-sm border border-stroke bg-white shadow-default">
                    ...
                    <form action="/loans" method="POST">
                        ...
                        <div class="p-6.5">
                        <div class="mb-4.5">
                            <label class="mb-3 block text-sm font-medium text-black"> Car <span class="text-meta-1">*</span> </label>
                            ...
                            <div class="mb-6">
                                <label class="mb-3 block text-sm font-medium text-black"> Total Cost <span class="text-meta-1">*</span> </label>
                                <textarea
                                    id="total_cost"
                                    name="total_cost"
                                    type="date"
