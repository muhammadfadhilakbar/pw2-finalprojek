...
<main>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2">
            <div class="flex flex-col">
                ...
                <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                    ...
                    <form enctype="multipart/form-data" action="/loans/{{ $loan->id }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="p-6.5">
                            <div class="mb-4.5">
                                <label class="mb-3 block text-sm font-medium text-black dark:text-white"> Car <span class="text-meta-1">*</span> </label>
                            ...
                            <div class="mb-6">
                                <label class="mb-3 block text-sm font-medium text-black dark:text-white"> Loan Date <span class="text-meta-1">*</span> </label>
                                <textarea
                                    id="loan_date"
                                    name="loan_date"
                                    type="text"
                            ...
                            <div class="mb-6">
                                <label class="mb-3 block text-sm font-medium text-black dark:text-white"> Total Cost <span class="text-meta-1">*</span> </label>
                                <textarea
                                    id="total_cost"
                                    name="total_cost"
                                    type="text"
    ...
    <select id="status" name="status"
        ...
        <option value="approved" {{ $loan->status === 'dipinjam' ? 'selected' : '' }}>dipinjam</option>
        <option value="rejected" {{ $loan->status === 'sudah kembali' ? 'selected' : '' }}>sudah kembali</option>
    </select>
</div>
