                ...
                <div class="rounded-sm border border-stroke bg-white shadow-default">
                    ...
                    <form enctype="multipart/form-data" action="/cars" method="POST">
                        ...
                        <div class="p-6.5">
                            ...
                            <div class="mb-6">
                                <label class="mb-3 block text-sm font-medium text-black"> Cost <span class="text-meta-1">*</span> </label>
                                <textarea
                                    id="cost_per_day"
                                    name="cost_per_day"
                                    type="text"
                            ...
                            <div class="mb-6">
                                <label class="mb-3 block text-sm font-medium text-black"> License <span class="text-meta-1">*</span> </label>
                                <textarea
                                    id="lisence_plate"
                                    name="license_plate"
                                    type="text"
