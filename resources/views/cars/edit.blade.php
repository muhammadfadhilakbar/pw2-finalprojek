                ...
                <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                    ...
                    <form enctype="multipart/form-data" action="/cars/{{ $car->id }}" method="POST">
                        ...
                        <div class="p-6.5">
                            ...
                            <div class="mb-6">
                                <label class="mb-3 block text-sm font-medium text-black dark:text-white"> Plate <span class="text-meta-1">*</span> </label>
                                <textarea
                                    id="license_plate"
                                    name="license_plate"
                                    type="text"
